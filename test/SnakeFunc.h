...
public:
            ...
            switch (snake2Direction) {
                case direction::RIGHT:
                    if (thisSectionPosition2.x > 800) {
                        ...
                        snake2[0].setPosition2(sf::Vector2f(thisSectionPosition2.x, thisSectionPosition2.y));
                    }
    ...
    void newSnake(/*sf:: Vector2f start*/) {
        ...
        snake2.push_back(sf::Vector2f(100, 150));
        snake2.push_back(sf::Vector2f(80, 150));
        snake2.push_back(sf::Vector2f(60, 150));
    }
